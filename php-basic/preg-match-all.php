...
<body>
    ...
    <p>
      <?php
        echo '一回以上繰り返されている(1文字以上の)英数字が含まれているかどうかを正規表現で検索し、検索結果を配列に代入します。<br>';
        if (preg_match_all('/[a-zA-Z0-9]+/' , $str , $results)) {
          echo '>検索結果:';
          print_r($results);
        } else {
    ...
    <p>
      <?php
        echo '改行以外の一回以上繰り返されている（１文字以上の）文字が含まれているかどうかを正規表現で検索し、検索結果を配列に代入します。<br>';
      ...
      ?>
        ...
        <p>
          <?php
          echo '「あ」で始まって「り」で終わる文字列と完全に一致しているどうかを正規表現で検索します。<br>';
